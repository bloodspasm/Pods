Pod::Spec.new do |s|
  ...
  s.license      = "MIT"                #开源协议
  s.author       = { "bloodspasm" => "164440931@qq.com" }

  s.source       = { :git => "https://github.com/bloodspasm/CocoaFRP.git" }
  ...
  s.source_files  = "CocoaFRP/*.{h,m}"    #OC可以使用类似这样"Classes/**/*.{h,m}"

  s.frameworks = 'UIKit', 'Foundation'    #所需的framework,多个用逗号隔开
  s.module_name = 'CocoaFRP'              #模块名称
